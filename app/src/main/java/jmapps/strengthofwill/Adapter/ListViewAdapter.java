package jmapps.strengthofwill.Adapter;
...
public class ListViewAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        TextView chapterNumber = view.findViewById(R.id.tv_paragraph_number);
        TextView chapterTitle = view.findViewById(R.id.tv_chapter_title);

        String strChapterNumber = getCursor().getString(getCursor().getColumnIndex("Paragraph"));
        String strChapterTitle = getCursor().getString(getCursor().getColumnIndex("ChapterName"));
