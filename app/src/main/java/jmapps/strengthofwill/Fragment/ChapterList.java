...
import jmapps.strengthofwill.Adapter.ListViewAdapter;
...
public class ChapterList extends DialogFragment implements
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            Cursor cursor = database.rawQuery("SELECT * FROM " + "TABLE_CHAPTERS", null);
        ...
        listViewAdapter.setFilterQueryProvider(new FilterQueryProvider() {
            ...
            public Cursor runQuery(CharSequence constraint) {
                ...
                if (constraint == null || constraint.length() == 0) {
                    ...
                    return database.rawQuery("SELECT * FROM " + "TABLE_CHAPTERS", null);

                } else {

                    String lastState = String.valueOf(constraint.toString());

                    return database.rawQuery("SELECT * FROM " + "TABLE_CHAPTERS " + "WHERE " +
                                    "Paragraph " + "LIKE ?" + " OR " + "ChapterName " + "LIKE ?",
